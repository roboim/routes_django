    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance_km', models.DecimalField(decimal_places=1, max_digits=6, verbose_name='Дистанция')),
                ...
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='routes', to='forecast.category', verbose_name='Категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='route_weathers', to='forecast.route', verbose_name='Маршрут')),
            ],
            options={
